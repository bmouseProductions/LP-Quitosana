...
export default function SectionForm(){
    return (
        <section className="" >
            <div className="py-10 md:py-14 xl:py-20 md:px-[5%] xl:px-[95px] bg-img-dark" data-aos="fade-right" data-aos-duration="1500">
                <div className="max-w-[1400px] flex flex-col lg:flex-row items-center lg:justify-between lg:gap-10 m-auto text-white">
                    ...
                    <div className="w-full lg:1/2 mt-10 lg:mt-0" id='form'>
                        <div className="max-w-[700px] m-auto py-10 px-5 flex flex-col items-center  bg-[#f55303] md:rounded-2xl shadow-2xl">
