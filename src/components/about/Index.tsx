...
import AcordionComponent2 from '../accordion2/Index'
...
export default function About(){
    return(
        <section className='w-full py-10 bg-gradient-to-b bg-[#006131]' >
            <div className='w-ful p-5 flex flex-col items-center lg:flex-row lg:justify-center gap-10'data-aos="fade-up" data-aos-duration="1500">
                ...
                <div className='flex flex-col gap-5 lg:hidden'>
                    <AcordionComponent2 
                        ...
                        style="w-[100%] md:w-[550px] rounded text-black" //syles gerais
